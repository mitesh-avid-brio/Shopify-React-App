...
function Inventory () {
    ...
    useEffect(() => {
        console.log("dad",`https://aec14829c6068d3c7209b0fb1c99cfa1:${process.env.NEXT_PUBLIC_SHOPIFY_PASSWORD_KEY}@${process.env.NEXT_PUBLIC_SHOPIFY_BASE_URL}/api/2024-07/products.json`)
