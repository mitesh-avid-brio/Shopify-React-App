...
function Inventory () {
    ...
    useEffect(() => {
        ...
        fetch(`https://e5f3474e5bad3bd824f6bb4233a78c7d:${process.env.NEXT_PUBLIC_SHOPIFY_PASSWORD_KEY}@${process.env.NEXT_PUBLIC_SHOPIFY_BASE_URL}/api/2024-07/products.json`,{
            method: "GET",
            headers:{
