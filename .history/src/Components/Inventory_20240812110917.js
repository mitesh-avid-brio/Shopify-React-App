...
function Inventory () {
    ...
    useEffect(() => {
        console.loh("dad",`https://${process.env.API_KEY}:${process.env.Access_Token}@${process.env.URL}/api/2024-07/products.json`)
        fetch(`https://${process.env.API_KEY}:${process.env.Access_Token}@${process.env.URL}/api/2024-07/products.json`,{
            method: "GET",
            headers:{
