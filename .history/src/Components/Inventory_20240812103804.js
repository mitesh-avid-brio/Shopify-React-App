...
function Inventory () {
    ...
    useEffect(() => {
        fetch('https://${process.env.api_KEY}:${process.env.NEXT_PUBLIC_SHOPIFY_PASSWORD_KEY}@${process.env.NEXT_PUBLIC_SHOPIFY_BASE_URL}/admin/api/2024-07/products.json?limit=3',{
            method: "GET",
            headers:{
