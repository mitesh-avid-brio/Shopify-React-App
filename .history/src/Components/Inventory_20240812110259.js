...
function Inventory () {
    ...
    useEffect(() => {
        ...
        fetch(`https://${process.env.NEXT_PUBLIC_API_KEY}:${process.env.NEXT_PUBLIC_SHOPIFY_PASSWORD_KEY}@${process.env.NEXT_PUBLIC_SHOPIFY_BASE_URL}/api/2024-07/products.json`,{
            method: "GET",
            headers:{
