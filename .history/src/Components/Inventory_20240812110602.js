...
function Inventory () {
    ...
    useEffect(() => {
        console.log("dad",`https://e5f3474e5bad3bd824f6bb4233a78c7d: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@pakt-shirts.myshopify.com/admin/api/2024-07/products.json`)
