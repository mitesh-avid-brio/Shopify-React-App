...
function Inventory () {
    ...
    useEffect(() => {
        console.log("dad",`https://aec14829c6068d3c7209b0fb1c99cfa1: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@${process.env.NEXT_PUBLIC_SHOPIFY_BASE_URL}/api/2024-07/products.json`)
